...
import {GLSLConstants} from "../../const/GLSL-constants";
...
export class WebGlService {
  ...
  initializeShaders(): WebGLProgram {
    ...
    let shaderProgram = this.gl.createProgram() as WebGLProgram;
  ...
  private loadShader(shaderSource: string, shaderType: string): WebGLShader | null {
    ...
    const glShader = this.gl.createShader(shaderTypeAsNumber) as WebGLShader;
